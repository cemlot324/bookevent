              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:border-[#4558a3] text-black placeholder-gray-500"
                    />
                  </div>
                  <div>
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    disabled={status === 'sending'}
                    className="bg-[#4558a3] text-white px-8 py-3 rounded-lg hover:bg-[#3a4b8c] transition-colors font-semibold"
                  >
